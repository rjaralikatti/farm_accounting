...
class FarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post farms_url, params: { farm: { address: @farm.address, city: @farm.city, country: @farm.country, name: @farm.name, state: @farm.state } }
    end
  ...
  test "should update farm" do
    patch farm_url(@farm), params: { farm: { address: @farm.address, city: @farm.city, country: @farm.country, name: @farm.name, state: @farm.state } }
